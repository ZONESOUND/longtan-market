...
let playerUI;
let player = new Player(adminFile, ()=>{
...
let changeState = (e) => {
    console.log('changeState', e, e.state);
    if (e.state == 'play') {
...
playerUI = new PlayerUI('player', 'menuinner', null, {songname: '市場', second: true, range: true, usePlay: false, callback: changeState});
